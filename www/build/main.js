...
var HomePage = /** @class */ (function () {
    function HomePage(navCtrl, httpClient) {
        ...
        this.stocks = ['ABEV3.SA', 'PETR4.SA', 'BBAS3.SA', 'BRFS3.SA', 'CAML3.SA', 'CVCB3.SA', 'EZTC3.SA', 'GOLL4.SA', 'IRBR3.SA', 'ITSA4.SA', 'RAIL3.SA', 'SAPR11.SA', 'VULC3.SA'];
    ...
    HomePage.prototype.ngOnInit = function () {
        ...
        for (var i = 0; i < this.stocks.length; i++) {
            this.getPrice(this.stocks[i]).subscribe(function (data) {
                //this.result = data
                var myObjJSON = JSON.stringify(data['Time Series (Daily)']);
                var myObjSTR = JSON.parse(myObjJSON);
                Object.keys(myObjSTR).sort();
                //this.myArrayLen = Object.keys(myObjSTR).length;
                _this.symbol = JSON.stringify(data['Meta Data']['2. Symbol']);
                _this.symbol = _this.symbol.replace('.SA', '');
                _this.symbol = _this.symbol.replace('"', '');
                _this.symbol = _this.symbol.replace('"', '');
                _this.lastDay = Object.keys(myObjSTR)[0];
...
var ListPage = /** @class */ (function () {
    ...
    ListPage = ListPage_1 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-list',template:/*ion-inline-start:"C:\Users\r.brassoroto\Documents\GitHub\myStocks\src\pages\list\list.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>List</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n  <ion-list>\n    <button ion-item *ngFor="let item of items" (click)="itemTapped($event, item)">\n      <ion-icon [name]="item.icon" item-start></ion-icon>\n      {{item.title}}\n      <div class="item-note" item-end>\n        {{item.note}}\n      </div>\n    </button>\n  </ion-list>\n  <div *ngIf="selectedItem" padding>\n    You navigated here from <b>{{selectedItem.title}}</b>\n  </div>\n</ion-content>\n'/*ion-inline-end:"C:\Users\r.brassoroto\Documents\GitHub\myStocks\src\pages\list\list.html"*/
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__angular_common_http__ = __webpack_require__(100);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__providers_api_stock_call_api_stock_call__ = __webpack_require__(276);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_9__providers_api_stock_call_api_stock_call__["a" /* ApiStockCallProvider */]
            ]
        })
    ], AppModule);
    return AppModule;
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"C:\Users\r.brassoroto\Documents\GitHub\myStocks\src\app\app.html"*/'<ion-menu [content]="content">\n  <ion-header>\n    <ion-toolbar>\n      <ion-title>Menu</ion-title>\n    </ion-toolbar>\n  </ion-header>\n\n  <ion-content>\n    <ion-list>\n      <button menuClose ion-item *ngFor="let p of pages" (click)="openPage(p)">\n        {{p.title}}\n      </button>\n    </ion-list>\n  </ion-content>\n\n</ion-menu>\n\n<!-- Disable swipe-to-go-back because it\'s poor UX to combine STGB with side menus -->\n<ion-nav [root]="rootPage" #content swipeBackEnabled="false"></ion-nav>'/*ion-inline-end:"C:\Users\r.brassoroto\Documents\GitHub\myStocks\src\app\app.html"*/
        }),
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ApiStockCallProvider; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
...
var ApiStockCallProvider = /** @class */ (function () {
    function ApiStockCallProvider(httpClient) {
        this.httpClient = httpClient;
        this.myArrayLen = 0;
        //console.log('Hello ApiStockCallProvider Provider');
    }
    ApiStockCallProvider.prototype.getStockPrice = function (symbol) {
    ...
    ApiStockCallProvider = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["A" /* Injectable */])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_common_http__["a" /* HttpClient */]])
    ], ApiStockCallProvider);
    return ApiStockCallProvider;
}());

//# sourceMappingURL=api-stock-call.js.map
